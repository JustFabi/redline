...
pub fn generate_pawn_moves(board: &Board, moves: &mut Vec<Move>) {
    match board.side_to_move {
        Color::White => generate_white_pawns(board, moves),
        Color::Black => generate_black_pawns(board, moves),
    }
}
...
/// WHITE PAWNS
/// =======================
fn generate_white_pawns(board: &Board, moves: &mut Vec<Move>) {
...
/// BLACK PAWNS
/// =======================
fn generate_black_pawns(board: &Board, moves: &mut Vec<Move>) {
